...
export const DEMO_VEHICLES: DemoVehicle[] = [
  ...
  {
    slug: "1991-911-carrera-964",
    year: 1991, make: "Porsche", model: "911 Carrera", trim: "Carrera 2", generation: "964",
    bodyStyle: "Coupe", exteriorColor: "Grand Prix White", interiorColor: "Tan",
    mileage: 68400, transmission: "5-speed manual", engine: "3.6L air-cooled flat-six", drivetrain: "RWD",
    vinPublicMode: "hidden", titleStatus: "Clean", ownershipStatus: "Own", saleStatus: "Not for sale",
    photo: "/demo-cars/white-964.jpg",
    options: ["Factory sunroof", "Cup-style wheels", "Power seats"],
    knownFlaws: "Typical age-related interior wear; light bolster softening on the driver's seat (photographed).",
    ownershipStory: "Owned and documented by me — a clean 964 Carrera in Grand Prix White over tan, kept in a private collection and maintained by an air-cooled specialist.",
    personalSignificance: "A lifelong dream car and the cornerstone of the collection.",
    archiveNotes: "A 964 Carrera in Grand Prix White over tan — an air-cooled 911 documented with care.",
    provenanceHighlights: ["Owner-documented", "Air-cooled specialist maintained", "Grand Prix White over tan"],
    privacyStatus: "public", sellerReadiness: 76, auctionReadiness: 79, completeness: 84,
    service: [
      { date: "2016-04-10", mileage: 55000, vendor: "Air-cooled specialist", category: "major service", summary: "Valve adjustment, fluids, belts", cost: 2100 },
      { date: "2019-05-22", mileage: 62000, vendor: "Air-cooled specialist", category: "major service", summary: "Top end inspection, oil service", cost: 1850 },
      { date: "2023-03-14", mileage: 67000, vendor: "Air-cooled specialist", category: "service", summary: "Annual service, new tires", cost: 2400 },
    ],
    ...
    documents: [{ type: "Service records", name: "service-history.pdf", isPrivate: false }, { type: "Inspection report", name: "ppi.pdf", isPrivate: false }],
    photos: [{ category: "front 3/4", caption: "Grand Prix White 964" }, { category: "engine", caption: "Air-cooled 3.6" }, { category: "undercarriage", caption: "Clean undercarriage" }],
    instagram: [{ hook: "Grand Prix White, air-cooled", caption: "1991 964 Carrera 2 in Grand Prix White over tan. Specialist-maintained. #aircooled #964" }],
    ad: { headline: "1991 964 Carrera 2, specialist-maintained", primaryText: "Documented air-cooled 911 in Grand Prix White. Review the archive." },
    ...
    listingDraft: "1991 Porsche 911 Carrera 2 (964) in Grand Prix White over tan. 68,400 miles, 5-speed manual. Specialist-maintained, well documented.",
  },
  {
